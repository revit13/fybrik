...
import (
	...
	apiv1alpha1 "github.com/mesh-for-data/the-mesh-for-data/manager/apis/app/v1alpha1"
...
var _ = Describe("M4DApplication Controller", func() {
	Context("M4DApplication", func() {
		...
		It("Test end-to-end for M4DApplication", func() {
			...
			fqdn := "test-app-e2e-default-read-module-test-e2e-ffea578653.m4d-blueprints.svc.cluster.local"
