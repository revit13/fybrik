...
Place image files in the [docs/static](https://github.com/mesh-for-data/the-mesh-for-data/tree/master/site/docs/static) directory. Use regular Markdown syntax for images. For example:
