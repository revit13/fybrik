...
These steps are described in the following sections in more detail, so that you can create your own modules for use by Mesh for Data.  Note that a new module is maintained in its own git repository, separate from the [the-mesh-for-data](https://github.com/mesh-for-data/the-mesh-for-data) repository.
...
<!-- TODO: expand this when we support setting values in the M4DModule YAML: https://github.com/mesh-for-data/the-mesh-for-data/pull/42 -->
...
You can use the [hack/make-rules/helm.mk](https://github.com/mesh-for-data/the-mesh-for-data/blob/master/hack/make-rules/helm.mk) Makefile, or manually push the chart:
...
* An example YAML for a module that [copies from db2 to s3](https://github.com/mesh-for-data/the-mesh-for-data/blob/master/manager/testdata/e2e/module-implicit-copy-db2wh-to-s3.yaml) and includes transformation actions 
