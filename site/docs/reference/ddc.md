...
in memory. The fetching of secrets will be executed by the [datamover](https://github.com/mesh-for-data/the-mesh-for-data-mover) component.
...
The [data distribution core libraries](https://github.com/mesh-for-data/the-mesh-for-data-mover) that are Scala/Spark based

The [data distribution operator](https://github.com/mesh-for-data/the-mesh-for-data) has been integrated into
