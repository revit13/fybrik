...
// +kubebuilder:webhook:admissionReviewVersions=v1;v1beta1,sideEffects=None,path=/mutate-motion-fybrik-ibm-com-v1alpha1-batchtransfer,mutating=true,failurePolicy=fail,groups=motion.m4d.ibm.com,resources=batchtransfers,verbs=create;update,versions=v1alpha1,name=mbatchtransfer.kb.io
...
// +kubebuilder:webhook:verbs=create;update,admissionReviewVersions=v1;v1beta1,sideEffects=None,path=/validate-motion-fybrik-ibm-com-v1alpha1-batchtransfer,mutating=false,failurePolicy=fail,groups=motion.m4d.ibm.com,resources=batchtransfers,versions=v1alpha1,name=vbatchtransfer.kb.io
